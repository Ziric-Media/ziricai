...
export const PACK_DEMO_RATINGS = {
    ...
    "pack-marketing-ai": { average: 4.6, count: 94 },
    "pack-collections-ai": { average: 4.5, count: 76 },
...
const CATEGORY_INTEGRATIONS = {
    ...
    marketing: ["whatsapp", "webchat", "email", "facebook", "instagram"],
    finance: ["whatsapp", "email", "webchat"],
    hr: ["whatsapp", "email", "webchat"],
    support: ["whatsapp", "email", "webchat"],
    administration: ["whatsapp", "email", "webchat", "google_calendar"],
    operations: ["whatsapp", "email", "google_calendar"],
